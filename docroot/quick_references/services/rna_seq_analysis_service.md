...
The RNA-Seq Service can be accessed from the Services Menu at the top of the MAAGE website page and via the Command Line Interface (CLI).
...
The **RNA-Seq Analysis** submenu option under the **Services** main menu (Transcriptomics category) opens the RNA-Seq Analysis input form (*shown below*). *Note: You must be logged into MAAGE to use this service.*
...
* **gene_exp.gmx** - This file, generated by MAAGE, describes the different contrast comparisons between conditions in terms of log ratios.
