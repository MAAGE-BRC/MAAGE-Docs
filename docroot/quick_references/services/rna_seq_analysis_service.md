...
The RNA-Seq Service can be accessed from the Services Menu at the top of the page and via the Command Line Interface (CLI).
...
* **gene_exp.gmx** - This file describes the different contrast comparisons between conditions in terms of log ratios.
