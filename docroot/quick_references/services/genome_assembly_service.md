...
The **Assembly** submenu option under the **Services** main menu (Genomics category) opens the Genome Assembly input form, shown below. *Note: You must be logged in to use this service.*

![Assembly Menu](../../tutorial/main_menu.png)
