...
## Overview
The bacterial Similar Genome Finder Service will find similar public genomes or compute genome distance estimation using [Mash/MinHash](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4915045/). It returns a set of genomes matching the specified similarity criteria. 
...
Selection box for specifying a genome to use as the basis of comparison

### Or Upload FASTA
Alternate option for uploading a FASTA file to use as the basis of comparison. *Note: You must be logged in to use this option.* 
...
**Scope:** Option for limiting the search to only Reference and Representative genomes, or all available genomes.
