...
========================
The top-level Organisms Menu provides direct access to genus-level data for bacteria and viruses selected based on their significance as current and emerging public health threats. It also provides direct access to summary-level data for all bacteria, viruses, archaea, phages, and eukaryotic hosts on the platform. The platform hosts organisms outside of what is listed in the organism menu. Click "All Bacteria" and "All Viruses" to access the full list of organisms on the platform.

.. image:: ../tutorial/organisms_menu.png
