...
# -*- coding: utf-8 -*-
#
# MAAGE documentation build configuration file, created by
...
project = 'MAAGE'
copyright = '2023 | The MAAGE Team'
author = 'The MAAGE Team'
...
# Custom Theme styles to match MAAGE main styles
...
# html_theme_path is no longer needed with modern sphinx-rtd-theme
html_logo = "_static/maage_logo.png"
...
latex_documents = [
    (master_doc, 'MAAGE.tex', 'MAAGE Documentation',
     'MAAGE team', 'manual'),
]
...
man_pages = [
    (master_doc, 'maage', 'MAAGE Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MAAGE', 'MAAGE Documentation',
     author, 'MAAGE', 'One line description of project.',
     'Miscellaneous'),
]
...
# recommonmark workaround removed -- using myst_parser instead
