...
The MAAGE Help Documentation is organized into several subsections:
 ...
 - `Quick Start <./quick_start/index.html>`_: provides set of introductory videos and documents designed to help users, especially those coming from PATRIC and IRD/ViPR, get started using MAAGE.
