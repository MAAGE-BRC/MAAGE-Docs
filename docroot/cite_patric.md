...
If you use the platform's web resources to assist in research publications or proposals please cite as:
...
For annotations generated using the RASTtk-enabled Genome Annotation Service, please cite:
...
For a list of all publications, please visit the <a href="./publications.html">**Publications page**</a>.