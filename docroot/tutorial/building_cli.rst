...
Clone the distribution and tools::
...
desktop session is suitable::
  ...
  distro-build-mac-app --app-name PATRIC --icon ~/icon/patric.icns --banner "Welcome to the Command Line Interface." ../build-1
...
desktop session is suitable::
  ...
  checkout-from-manifest ../build-1
  export KB_IGNORE_MISSING_DEPENDENCIES=1
  distro-build-ubuntu-app --ignore --app-name patric-cli --banner "Welcome to the Command Line Interface." --description "The Command Line Interface" ../build-1
